...
| **Image Editing** | `wan2.5-i2i-preview` (Model Studio) 🖼️ |
...
## AI Pipeline ⚙️
1. **Image Synthesis** 🖼️: `wan2.5-i2i-preview` takes the room photo + style reference to generate the renovated image.
2. **TTS Generation** 🎙️: `qwen3-tts-flash` creates the narration audio.
3. **Video Synthesis** 🎬: `wan2.1-kf2v-plus` renders a cinematic transition between the original and renovated rooms.
4. **Final Assembly** 🛠️: `ffmpeg` merges the silent video with the generated narration.
